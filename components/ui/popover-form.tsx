    ...
    <div className="relative">
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            layoutId={`${typeof title === "string" ? title : "popover-form"}-wrapper`}
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-1 overflow-hidden bg-muted shadow-[0_0_0_1px_rgba(0,0,0,0.08),0px_1px_2px_rgba(0,0,0,0.04)] outline-none z-50"
            ref={ref}
